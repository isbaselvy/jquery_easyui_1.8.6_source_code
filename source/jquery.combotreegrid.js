...
(function ($) {
    ...
    function _28(_29, q) {
        ...
        if (_2b.mode == "remote") {
            _2d(qq);
            _2c.treegrid("load", $.extend({}, _2b.queryParams, {
                q: q
            }));
        } else {
            if (q) {
    ...
    $.fn.combotreegrid = function (_34, _35) {
        ...
        return this.each(function () {
            ...
            if (_37) {
                ...
                _37 = $.data(this, "combotreegrid", {
                    options: $.extend({}, $.fn.combotreegrid.defaults, $.fn.combotreegrid.parseOptions(this), _34)
                });
            }
            _1(this);
        });
    ...
    $.fn.combotreegrid.parseOptions = function (_3e) {
        var t = $(_3e);
        return $.extend({}, $.fn.combo.parseOptions(_3e), $.fn.treegrid.parseOptions(_3e), $.parser.parseOptions(_3e, ["mode", {
            limitToGrid: "boolean"
        }]));
    };
